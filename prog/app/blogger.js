class BloggerRunProgram extends Program {
  getGameURL() {
    return 'https://vigneshwaranhr.blogspot.com/';
  }
  ...
  onAttach() {
    ...
    bodyEl.classList.add('window__Blogger');
...
window.pm.registerPrototype('Blogger', BloggerRunProgram);
